function [numAtr, nClases, infoAtr, ejemplosTr, ejemplosTst, ejClase] = lecturaDatos(fTrain, fTest)
...
cont = 0;
k=1;
while sum(strfind(line1,'@output')) == 0
    ...
    if sum(strfind(line1, '@output')) > 0
        [aux, out] = strtok(line1);
    end
    k = k+1;
end
